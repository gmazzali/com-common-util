...
public class LogEntry implements Serializable {
	 ...
	 */
	public LogEntry(LogLevel logLevel, String message, String keyMessage, Object... parameters) {
		super();
	...
	/**
	 * Retrieve the default message of this log (not the message refer of ths key message).
	 * 

...
public class ValidationException extends UncheckedException {
	...
	/**
	 * El constructor de una instancia de {@link ValidationException} que no recibe parámetros.
	 */
	...
	/**
	 * El constructor de una instancia de {@link ValidationException} que recibe como parámetro un elemento {@link Throwable} para mantener el
	...
	/**
	 * El constructor de una instancia de {@link ValidationException} que recibe como parámetro el conjunto de {@link Errors} que vamos a contener.
	 * 
	 * @param errors
	...
	/**
	 * El constructor de una instancia de {@link ValidationException} que recibe como parámetro el {@link Throwable} para mantener el problema que
	...
	/**
	 * El constructor de una instancia de {@link ValidationException} que recibe como parámetro un mensaje de {@link ErrorDetail} que vamos a crear en
	 * el momento.
	 * 
	 * @param defaultMessage
	 *            El mensaje por omisión del detalle del error.
